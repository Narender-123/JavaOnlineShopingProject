...
<table id="customers">
 ...
 try{
	 ...
	 ResultSet rs = smt.executeQuery("Select * From cart Inner Join product where product.id=cart.product_id and cart.orderDate Is Not Null and cart.status='Cancel'");
while(rs.next()){
 %>       
